...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .flash-status{
    background:#e9f9ee;color:#227a4a;font-weight:800;font-size:13px;
  ...
  .remember-row{display:flex;align-items:center;justify-content:space-between;margin:18px 0 22px;}
  .remember-label{display:flex;align-items:center;gap:8px;font-size:13px;font-weight:700;color:var(--ink-soft);}
  .remember-label input{width:16px;height:16px;accent-color:var(--orange-deep);}
  .forgot-link{font-size:12.5px;font-weight:800;color:var(--blue);text-decoration:none;}
...
<div class="shell">
  ...
  <section class="illustration">
    ...
    <div class="hero-text">
      <h1>Setiap makanan yang kamu catat, menghidupkan karaktermu.</h1>
      <p>Scan foto makananmu, biarkan AI menghitung nutrisinya, dan jaga karaktermu tetap sehat dan naik level.</p>
    </div>

    <div class="feature-list">
      <div class="feature-item">
        <div class="feature-icon">📷</div>
        <div class="feature-text">Scan foto makanan, AI langsung hitung nutrisinya</div>
      </div>
      <div class="feature-item">
        <div class="feature-icon">❤️</div>
        <div class="feature-text">Jaga HP karaktermu dengan pola makan seimbang</div>
      </div>
      <div class="feature-item">
        <div class="feature-icon">⚡</div>
        <div class="feature-text">Kumpulkan XP dan naik level setiap hari</div>
      </div>
    </div>

    <div class="bunny-wrap">
      <div class="level-tag">Lv. 1</div>
  ...
  <section class="form-side">
    <div class="form-card">
      ...
      <p class="sub">Lanjutkan progres karaktermu hari ini.</p>
